...
for i in $(find templates/$dir/extra templates/common/fontmap/*.tec ! -type d); do echo $i; name=$(basename $i); echo $name;cat $i|7za a /tmp/extraTemplate/extra.7z -si${name} ;done
