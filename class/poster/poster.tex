...
\usepackage{hasanCustom}

% Title portion
$if(title)$
\title{$title$}
$endif$
%--%\title{First-Principles Study on \\Electronic and Magnetic Structures \\of Nickel Cobaltite spinel: \Large{DFT and QSGW methods}}
 ...
 \begin{beamercolorbox}{footline}%
	 ...
	 \begin{columns}[t]
		 ...
		 \begin{column}{0.19\linewidth}
			 \center		 \includegraphics[height=8em]{$logo$}
		 \end{column}
		 \begin{column}{0.025\linewidth}
		 \end{column}
